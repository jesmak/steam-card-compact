...
// Lifted from the card's own markup: the Steam logo, drawn behind a player who isn't in a
// game. Its box is wider than the drawing, so the word keeps clear of the card's edge.
